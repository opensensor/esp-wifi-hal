...
NAMES = {
    'esp32c3': ['phy_wakeup_init', 'phy_close_rf', 'phy_get_rf_cal_version'],
    'esp32s3': ['phy_wakeup_init', 'phy_close_rf', 'phy_get_rf_cal_version', 'phy_set_tx_seed'],
}
HELPERS = {
    'esp32c3': ['ram1_phy_wakeup_init', 'get_rf_freq_init', 'rom1_tsens_temp_read', 'ram1_phy_close_rf'],
    'esp32s3': ['ram_phy_wakeup_init', 'get_rf_freq_init', 'ram_phy_close_rf'],
}

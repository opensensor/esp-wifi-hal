...
NAMES = {chip:['phy_dig_reg_backup','phy_freq_mem_backup','phy_set_most_tpw','phy_11p_set'] for chip in ['esp32c3','esp32s3']}
HELPERS = {chip:['rom_phy_dig_reg_backup','rom_phy_freq_mem_backup']+(['ram1_wifi_set_tx_gain'] if chip=='esp32c3' else []) for chip in NAMES}

...
def check_dc_search(base,symbols,expected,rx_gain_cal_source=False,spur_source=False):
...
def audit(elf_path,map_path,label,expected,rx_gain_cal_source=False,spur_source=False):
 from elftools.elf.elffile import ELFFile
 prior=previous.audit(elf_path,map_path,label,'source',dc_search_source=(expected=='source'),rx_gain_cal_source=rx_gain_cal_source,spur_source=spur_source);base=allocations.audit(elf_path,map_path,label,exclude_strings=True)
 ...
 check_dc_search(base,symbols,expected,rx_gain_cal_source=rx_gain_cal_source,spur_source=spur_source)

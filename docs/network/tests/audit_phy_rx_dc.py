...
def check_rx_dc(base,symbols,expected,dc_search_source=False,rx_gain_cal_source=False,spur_source=False):
...
def audit(elf_path,map_path,label,expected,dc_search_source=False,rx_gain_cal_source=False,spur_source=False):
 from elftools.elf.elffile import ELFFile
 prior=previous.audit(elf_path,map_path,label,'source',rx_dc_source=(expected=='source'),dc_search_source=dc_search_source,rx_gain_cal_source=rx_gain_cal_source,spur_source=spur_source);base=allocations.audit(elf_path,map_path,label,exclude_strings=True)
 ...
 check_rx_dc(base,symbols,expected,dc_search_source,rx_gain_cal_source=rx_gain_cal_source,spur_source=spur_source)

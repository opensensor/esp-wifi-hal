...
def check_controls(base,symbols,expected,iq_source=False,rf_iq_source=False,rx_dc_source=False,dc_search_source=False,rx_gain_cal_source=False,spur_source=False):
...
def audit(elf_path,map_path,label,expected,iq_source=False,rf_iq_source=False,rx_dc_source=False,dc_search_source=False,rx_gain_cal_source=False,spur_source=False):
 ...
 check_controls(base,symbols,expected,iq_source,rf_iq_source,rx_dc_source,dc_search_source,rx_gain_cal_source=rx_gain_cal_source,spur_source=spur_source)

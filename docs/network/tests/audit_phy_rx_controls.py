...
def check_controls(base,symbols,expected,iq_source=False,rf_iq_source=False):
...
def audit(elf_path,map_path,label,expected,iq_source=False,rf_iq_source=False):
 ...
 check_controls(base,symbols,expected,iq_source,rf_iq_source)

...
def check_rf_iq(base,symbols,expected,rx_dc_source=False,dc_search_source=False,rx_gain_cal_source=False):
...
def audit(elf_path,map_path,label,expected,rx_dc_source=False,dc_search_source=False,rx_gain_cal_source=False):
 from elftools.elf.elffile import ELFFile
 prior=previous.audit(elf_path,map_path,label,'source',rf_iq_source=(expected=='source'),rx_dc_source=rx_dc_source,dc_search_source=dc_search_source,rx_gain_cal_source=rx_gain_cal_source);base=allocations.audit(elf_path,map_path,label,exclude_strings=True)
 ...
 check_rf_iq(base,symbols,expected,rx_dc_source,dc_search_source,rx_gain_cal_source=rx_gain_cal_source)

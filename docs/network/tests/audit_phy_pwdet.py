...
def audit(elf_path,map_path,label,expected,*,hw_freq_source=False,reg_source=False,tx_gain_source=False,init_source=False):
    ...
    prior=debug.audit(elf_path,map_path,label,'source',hw_freq_source=hw_freq_source,reg_source=reg_source,tx_gain_source=tx_gain_source,init_source=init_source)

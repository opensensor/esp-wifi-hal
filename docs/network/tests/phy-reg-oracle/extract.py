...
NAMES = {'esp32c3': ['ram1_set_pbus_reg', 'rom1_tx_paon_set', 'btbb_wifi_bb_cfg2', 'rx_agc_reg_opt', 'rx_11b_opt', 'rom1_disable_wifi_agc', 'rom1_enable_wifi_agc', 'ram1_fe_i2c_reg_renew', 'phy_wifi_enable_set', 'txiq_set_reg', 'rxiq_set_reg', 'start_tx_tone_step', 'stop_tx_tone', 'rom1_set_noise_floor', 'phy_freq_correct', 'force_txrx_off'], 'esp32s3': ['ram_set_pbus_reg', 'ram_wifi_tx_dig_gain_reg', 'btbb_wifi_bb_cfg2', 'rx_agc_reg_opt', 'rx_11b_opt', 'ram_disable_wifi_agc', 'ram_enable_wifi_agc', 'ram_fe_i2c_reg_renew', 'phy_wifi_enable_set', 'txiq_set_reg', 'rxiq_set_reg', 'start_tx_tone_step', 'stop_tx_tone', 'ram_set_noise_floor', 'phy_freq_correct', 'force_txrx_off']}
    ...
    for name in NAMES[chip]:
        ...
        while pending:
            ...
            if op in ('beq', 'beqi', 'blt', 'bge', 'bne', 'beqz', 'beqz.n',
                      'bnez', 'bnez.n', 'blez', 'bgtz', 'blti', 'bany', 'bltz', 'bgez', 'bgeui', 'bltu', 'bnei', 'bbsi', 'bgeu', 'bgei', 'bltui', 'bgeui'):

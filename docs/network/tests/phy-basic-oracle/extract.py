...
NAMES = {'esp32c3':['rom1_i2c_master_reset','chan14_mic_cfg'],
         'esp32s3':['ram_i2c_master_reset','chan14_mic_cfg','ram_set_chan_cal_interp']}
HELPERS = {chip:['phy_i2c_enter_critical','phy_i2c_exit_critical','phy_set_most_tpw','rom_set_chan_reg'] for chip in NAMES}
